        ...
        <div className='bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded -xl shadow-md hover:shadow-lg transition-all p-5 flex flex-col'>
            {isEdit ? (
                <>
                    ...
                    <div className='flex gap-2'>
                        <button
                            ...
                            className='bg-green-500 hover:bg-gray-500 text-white px-4 py-1.5 rounded-lg transition'
                        >
                            Save
                        </button>
                        <button
                            onClick={() => setIsEdit(false)}
                            className='bg-red-500 hover:bg-gray-500 text-white px-4 py-1.5 rounded-lg transition'
                        >
                            Cancel
                        </button>
                    </div>
                ...
                <>
                    ...
                    <p className='text-gray-600 dark:text-gray-300 mt-2 flex-1'>{note.content}</p>
